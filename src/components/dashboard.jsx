...
const Dashboard = () => {
  ...
  return (
    <div className="dashboard">
      ...
      <label htmlFor="currencyFilter">Currency Filter:</label>
      <select
        id="currencyFilter"
      ...
      <div className="stats">Unique Regions: {uniqueRegions}</div>

      <div className="stats">
        Countries Per Region = {totalCountriesPerRegion.join(", ")}
      </div>
      <ul>
